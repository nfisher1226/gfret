...
impl Gui {
    ...
    pub(crate) fn load_template(&self, template: &Template) {
...
fn build_ui(application: &Application) -> Rc<Gui> {
    ...
    gui.setup();
    Actions::default().add(&gui, application);
